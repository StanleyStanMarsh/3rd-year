...
### В папках лежат отчеты и все то, что не связано с прогой напрямую
...
[Клеточный автомат](https://github.com/StanleyStanMarsh/cellular-automaton)
...
[Лабы](https://github.com/python-SPbPU)
